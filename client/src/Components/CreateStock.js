...
export default class CreateStock extends Component {
  ...
  handleInputChange = (e) => {
    ...
    switch (name) {
      case "stockId":
        formErrors.stockId =
          value.length < 4 ? "Minimum character must be 4" : "";
        break;
      ...
      case "sOrderId":
        formErrors.sOrderId =
          value.length < 5 ? "Minimum character must be 5" : "";
        break;
      default:
        break;
    }
  ...
  render() {
    ...
    return (
      <div class="row">
        ...
        <div className="col-md-6">
          <img
            src="/Images/inventory1.png"
            alt="inventory"
            style={{ height: "700px", width: "700px", marginTop: "100px" }}
          />
        </div>
      </div>
    );
